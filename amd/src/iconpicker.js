...
(function(factory) {
        ...
        if (typeof define === 'function' && define.amd) {
            define(['jquery', 'mod_bootstrapelements/jquery.ui.pos'], factory);
        ...
        Iconpicker.prototype = {
            ...
            _createIconpicker: function() {
                ...
                for (var i in this.options.icons) {
                    ...
                    itemElement.data('iconpickerValue', this.options.icons[i]).on('click.iconpicker', itemClickFn);
            ...
            _isEventInsideIconpicker: function(e) {
                var _t = $(e.target);
                if ((!_t.hasClass('iconpicker-element') || (_t.hasClass('iconpicker-element') && !_t.is(this.element))) && (_t.parents('.iconpicker-popover').length === 0)) {
                    return false;
                }
                return true;
            },
